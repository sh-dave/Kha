...
class Assets {
	 ...
	 */
	public static function loadImage(name: String, done: Image -> Void, ?failed: Dynamic -> Void): Void {
		var description = Reflect.field(images, name + "Description");
	 ...
	 * @param	done A callback.
	 */
	public static function loadImageFromPath(path: String, readable: Bool, done: Image -> Void, ?failed: Dynamic -> Void): Void {
		var description = { files: [ path ], readable: readable };
		LoaderImpl.loadImageFromDescription(description, done, reporter(failed));
	}
	...
	public static function loadBlob(name: String, done: Blob -> Void, ?failed: Dynamic -> Void): Void {
		var description = Reflect.field(blobs, name + "Description");
	...
	public static function loadBlobFromPath(path: String, done: Blob -> Void, ?failed: Dynamic -> Void): Void {
		var description = { files: [ path ] };
		LoaderImpl.loadBlobFromDescription(description, done, reporter(failed));
	}

	public static function loadSound(name: String, done: Sound -> Void, ?failed: Dynamic -> Void): Void {
		var description = Reflect.field(sounds, name + "Description");
	...
	public static function loadSoundFromPath(path: String, done: Sound -> Void, ?failed: Dynamic -> Void): Void {
		var description = { files: [ path ] };
		return LoaderImpl.loadSoundFromDescription(description, done, reporter(failed));
	}
	...
	public static function loadFont(name: String, done: Font -> Void, ?failed: Dynamic -> Void): Void {
		var description = Reflect.field(fonts, name + "Description");
	...
	public static function loadFontFromPath(path: String, done: Font -> Void, ?failed: Dynamic -> Void): Void {
		var description = { files: [ path ] };
		return LoaderImpl.loadFontFromDescription(description, done, reporter(failed));
	}
	...
	public static function loadVideo(name: String, done: Video -> Void, ?failed: Dynamic -> Void): Void {
		var description = Reflect.field(videos, name + "Description");
	...
	public static function loadVideoFromPath(path: String, done: Video -> Void, ?failed: Dynamic -> Void): Void {
		var description = { files: [ path ] };
		return LoaderImpl.loadVideoFromDescription(description, done, reporter(failed));
	}
	...
	static inline function reporter(custom: Dynamic -> Void)
		return custom != null
			? custom
			: haxe.Log.trace.bind(_);
}
